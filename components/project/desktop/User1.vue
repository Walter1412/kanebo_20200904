...
<template lang="pug">
.users1.swiper-container(ref="users")
  // Additional required wrapper
  .swiper-wrapper
    // Slides
    .user.swiper-slide
      img.user-image(alt="" src="~assets/images/project/desktop/users1/user0.png")
      a.more.user0-more(href="https://www.instagram.com/p/CBdIC9yJ51T/?igshid=5wr90vrig61m" target="_blank")
        img(alt="" src="~assets/images/project/desktop/more.png")
    .user.swiper-slide
      img.user-image(alt="" src="~assets/images/project/desktop/users1/user1.png")
      a.more.user1-more(href="https://www.instagram.com/p/CBDX2gxpmo-/?igshid=12ch9txlq283k" target="_blank")
        img(alt="" src="~assets/images/project/desktop/more.png")
    .user.swiper-slide
      img.user-image(alt="" src="~assets/images/project/desktop/users1/user2.png")
